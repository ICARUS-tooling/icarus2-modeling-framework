 ...
 */
package de.ims.icarus2.model.standard.driver.io;

import gnu.trove.map.TIntObjectMap;
import gnu.trove.map.hash.TIntObjectHashMap;
import de.ims.icarus2.model.standard.driver.io.BufferedIOResource.Block;
...
public class UnlimitedBlockCache implements BlockCache {
	...
	/**
	 * @see de.ims.icarus2.model.standard.driver.io.BufferedIOResource.BlockCache#getBlock(int)
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.standard.driver.io.BufferedIOResource.BlockCache#addBlock(de.ims.icarus2.model.standard.driver.io.BufferedIOResource.Block, int)
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.standard.driver.io.BufferedIOResource.BlockCache#open(int)
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.standard.driver.io.BufferedIOResource.BlockCache#close()
	 */
	@Override
	public void close() {
		blocks = null;
