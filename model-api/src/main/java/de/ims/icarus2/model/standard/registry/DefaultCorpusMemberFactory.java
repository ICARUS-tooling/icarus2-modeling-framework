...
public class DefaultCorpusMemberFactory implements CorpusMemberFactory {
	 ...
	 *
	 * @see de.ims.icarus2.model.registry.CorpusMemberFactory#createContext(de.ims.icarus2.model.api.corpus.Corpus, de.ims.icarus2.model.api.manifest.ContextManifest, de.ims.icarus2.util.Options)
	 */
	@Override
...
//		return new DefaultContext(corpus, manifest);
	 ...
	 *
	 * @see de.ims.icarus2.model.registry.CorpusMemberFactory#createLayerGroup(de.ims.icarus2.model.api.manifest.LayerGroupManifest, de.ims.icarus2.util.Options)
	 */
	@Override
	 ...
	 *
	 * @see de.ims.icarus2.model.registry.CorpusMemberFactory#createAnnotationLayer(de.ims.icarus2.model.api.corpus.Corpus, de.ims.icarus2.model.api.manifest.AnnotationLayerManifest, de.ims.icarus2.util.Options)
	 */
	@Override
	 ...
	 *
	 * @see de.ims.icarus2.model.registry.CorpusMemberFactory#createItemLayer(de.ims.icarus2.model.api.corpus.Corpus, de.ims.icarus2.model.api.manifest.ItemLayerManifest, de.ims.icarus2.util.Options)
	 */
	@Override
	 ...
	 *
	 * @see de.ims.icarus2.model.registry.CorpusMemberFactory#createStructureLayer(de.ims.icarus2.model.api.corpus.Corpus, de.ims.icarus2.model.api.manifest.StructureLayerManifest, de.ims.icarus2.util.Options)
	 */
	@Override
	 ...
	 *
	 * @see de.ims.icarus2.model.registry.CorpusMemberFactory#createFragmentLayer(de.ims.icarus2.model.api.corpus.Corpus, de.ims.icarus2.model.api.manifest.FragmentLayerManifest, de.ims.icarus2.util.Options)
	 */
	@Override
