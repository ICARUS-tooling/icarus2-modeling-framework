...
//	private static final UnsignedNumbers NUMS = UnsignedNumbers.withOffset(-1);
	...
	private static class ShortSpanAdapter implements SpanAdapter {
		...
		/**
		 * @see de.ims.icarus2.model.standard.driver.mapping.SpanArrays.SpanAdapter#createBuffer(int)
		 */
		@Override
		...
		/**
		 * @see de.ims.icarus2.model.standard.driver.mapping.SpanArrays.SpanAdapter#bufferSize(java.lang.Object)
		 */
		@Override
		...
		/**
		 * @see de.ims.icarus2.model.standard.driver.mapping.SpanArrays.SpanAdapter#getFrom(int)
		 */
		@Override
		...
		/**
		 * @see de.ims.icarus2.model.standard.driver.mapping.SpanArrays.SpanAdapter#getTo(int)
		 */
		@Override
		...
		/**
		 * @see de.ims.icarus2.model.standard.driver.mapping.SpanArrays.SpanAdapter#setFrom(int, long)
		 */
		@Override
		...
		/**
		 * @see de.ims.icarus2.model.standard.driver.mapping.SpanArrays.SpanAdapter#setTo(int, long)
		 */
		@Override
		...
		/**
		 * @see de.ims.icarus2.model.standard.driver.mapping.SpanArrays.SpanAdapter#chunkSize()
		 */
		@Override
		...
		/**
		 * @see de.ims.icarus2.model.standard.driver.mapping.SpanArrays.SpanAdapter#read(java.lang.Object, java.nio.ByteBuffer, int, int)
		 */
		@Override
		...
		/**
		 * @see de.ims.icarus2.model.standard.driver.mapping.SpanArrays.SpanAdapter#write(java.lang.Object, java.nio.ByteBuffer, int, int)
		 */
		@Override
		...
		/**
		 * @see de.ims.icarus2.model.standard.driver.mapping.SpanArrays.SpanAdapter#findSorted(java.lang.Object, int, int, long)
		 */
		@Override
		...
		/**
		 * @see de.ims.icarus2.model.standard.driver.mapping.SpanArrays.SpanAdapter#getValueType()
		 */
		@Override
