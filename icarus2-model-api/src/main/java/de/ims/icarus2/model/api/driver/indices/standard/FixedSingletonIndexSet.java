 ...
 *
 */
public class FixedSingletonIndexSet implements IndexSet {
	...
	public static FixedSingletonIndexSet of(long index) {
		return new FixedSingletonIndexSet(index);
	}

	private final long index;

	public FixedSingletonIndexSet(long index) {
		if(index<0)
