 ...
 *
 */
class DriverManifestXmlDelegateTest implements ManifestXmlDelegateTest<DriverManifest, DriverManifestXmlDelegate> {

	/**
	 * @see de.ims.icarus2.test.GenericTest#getTestTargetClass()
	 */
	@Override
	public Class<? extends DriverManifestXmlDelegate> getTestTargetClass() {
		return DriverManifestXmlDelegate.class;
	}
	...
	void testResetContextManifest() {
		DriverManifestXmlDelegate delegate = create();
