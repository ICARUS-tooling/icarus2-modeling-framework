...
import de.ims.icarus2.model.standard.driver.mapping.chunks.ChunkArrays.ArrayAdapter;
...
public class DefaultChunkIndex extends BufferedIOResource implements ChunkIndex {
	...
	/**
	 * @see de.ims.icarus2.model.standard.driver.mapping.chunks.ChunkIndex#getFileSet()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.standard.driver.mapping.chunks.ChunkIndex#newReader()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.standard.driver.mapping.chunks.ChunkIndex#newWriter()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.standard.driver.io.BufferedIOResource#read(java.lang.Object, java.nio.ByteBuffer)
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.standard.driver.io.BufferedIOResource#write(java.lang.Object, java.nio.ByteBuffer, int)
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.standard.driver.io.BufferedIOResource#newBlockData()
	 */
	@Override
...
//		return (int)(index & (blockPower-1));
	...
	private class Reader extends ReadAccessor<ChunkIndex> implements ChunkIndexReader {
		...
		/**
		 * @see de.ims.icarus2.model.standard.driver.mapping.chunks.ChunkIndexReader#getEntryCount()
		 */
		@Override
		public long getEntryCount() {
		...
		/**
		 * @see de.ims.icarus2.model.standard.driver.mapping.chunks.ChunkIndexReader#getFileId(long)
		 */
		@Override
		...
		/**
		 * @see de.ims.icarus2.model.standard.driver.mapping.chunks.ChunkIndexReader#getBeginOffset(long)
		 */
		@Override
		...
		/**
		 * @see de.ims.icarus2.model.standard.driver.mapping.chunks.ChunkIndexReader#getEndOffset(long)
		 */
		@Override
	...
	private class Writer extends WriteAccessor<ChunkIndex> implements ChunkIndexWriter {
		...
		/**
		 * @see de.ims.icarus2.model.standard.driver.mapping.chunks.ChunkIndexWriter#setFileId(long, int)
		 */
		@Override
		...
		/**
		 * @see de.ims.icarus2.model.standard.driver.mapping.chunks.ChunkIndexWriter#setBeginOffset(long, long)
		 */
		@Override
		...
		/**
		 * @see de.ims.icarus2.model.standard.driver.mapping.chunks.ChunkIndexWriter#setEndOffset(long, long)
		 */
		@Override
