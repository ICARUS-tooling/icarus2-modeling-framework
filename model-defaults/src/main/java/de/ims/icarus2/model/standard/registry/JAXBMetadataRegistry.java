 ...
 * $URL: https://subversion.assembla.com/svn/icarusplatform/trunk/Icarus2Core/core/de.ims.icarus2.model/source/de/ims/icarus2/model/standard/driver/file/SharedChecksumStorage.java $
 *
 ...
 * @version $Id: SharedChecksumStorage.java 400 2015-05-29 13:06:46Z mcgaerty $
 *
 */
public class JAXBMetadataRegistry extends JAXBGate<JAXBMetadataRegistry.StorageBuffer> implements MetadataRegistry {
	...
	public static JAXBMetadataRegistry getStorage(Path file) {
		if (file == null)
