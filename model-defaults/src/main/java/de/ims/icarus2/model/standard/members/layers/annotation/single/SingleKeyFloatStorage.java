 ...
 * $URL: https://subversion.assembla.com/svn/icarusplatform/trunk/Icarus2Core/core/de.ims.icarus2.model/source/de/ims/icarus2/model/standard/members/layers/annotation/single/SingleKeyFloatStorage.java $
 *
 ...
 * @version $Id: SingleKeyFloatStorage.java 457 2016-04-20 13:08:11Z mcgaerty $
 *
 */
public class SingleKeyFloatStorage extends AbstractSingleKeyStorage {
	...
	private TObjectFloatMap<Item> annotations;
	...
	public void addNotify(AnnotationLayer layer) {
		...
		noEntryValue = declaredNoEntryValue==null ? DEFAULT_NO_ENTRY_VALUE : (float) declaredNoEntryValue;
	...
	public boolean removeItem(Item item) {
		return Float.compare(annotations.remove(item), noEntryValue)!=0;
	}
