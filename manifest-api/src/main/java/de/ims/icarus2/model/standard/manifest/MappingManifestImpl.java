 ...
 * $URL: https://subversion.assembla.com/svn/icarusplatform/trunk/Icarus2Core/core/de.ims.icarus2.model/source/de/ims/icarus2/model/standard/manifest/MappingManifestImpl.java $
 *
 ...
 * @version $Id: MappingManifestImpl.java 443 2016-01-11 11:31:11Z mcgaerty $
 *
 */
public class MappingManifestImpl extends AbstractLockable implements MappingManifest {
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.MappingManifest#getDriverManifest()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.MappingManifest#getSourceLayerId()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.MappingManifest#getTargetLayerId()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.MappingManifest#getRelation()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.MappingManifest#getCoverage()
	 */
	@Override
