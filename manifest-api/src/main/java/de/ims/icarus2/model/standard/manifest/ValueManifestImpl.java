...
public class ValueManifestImpl extends AbstractLockable implements ValueManifest {
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.ValueManifest#getValueType()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.ValueManifest#getValue()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.ValueManifest#getName()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.ValueManifest#getDescription()
	 */
	@Override
