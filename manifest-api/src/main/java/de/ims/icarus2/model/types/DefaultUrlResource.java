...
public class DefaultUrlResource implements UrlResource {
	...
	/**
	 * @see de.ims.icarus2.model.types.UrlResource#getUrl()
	 */
	@Override
	public Url getUrl() {
		return url;
	...
	/**
	 * @see de.ims.icarus2.model.types.UrlResource#getTitle()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.types.UrlResource#getDescription()
	 */
	@Override
