 ...
 * $URL: https://subversion.assembla.com/svn/icarusplatform/trunk/Icarus2Core/core/de.ims.icarus2.model/source/de/ims/icarus2/model/standard/manifest/LayerGroupManifestImpl.java $
 *
 ...
 * @version $Id: LayerGroupManifestImpl.java 443 2016-01-11 11:31:11Z mcgaerty $
 *
 */
public class LayerGroupManifestImpl extends DefaultModifiableIdentity implements LayerGroupManifest {
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.LayerGroupManifest#getContextManifest()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.LayerGroupManifest#layerCount()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.LayerGroupManifest#getLayerManifests()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.LayerGroupManifest#getPrimaryLayerManifest()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.LayerGroupManifest#isIndependent()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.LayerGroupManifest#getLayerManifest(java.lang.String)
	 */
	@Override
