...
import de.ims.icarus2.model.api.manifest.Lockable;
...
public abstract class AbstractLockable implements Lockable {
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.ManifestFragment#lock()
	 */
	@Override
	public void lock() {
		locked = true;
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.ManifestFragment#isLocked()
	 */
	@Override
