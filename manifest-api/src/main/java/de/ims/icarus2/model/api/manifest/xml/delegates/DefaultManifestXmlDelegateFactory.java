...
import de.ims.icarus2.model.api.manifest.xml.ManifestXmlDelegate;
import de.ims.icarus2.model.api.manifest.xml.ManifestXmlDelegateFactory;
import de.ims.icarus2.model.api.manifest.xml.delegates.DriverManifestXmlDelegate.ModuleManifestXmlDelegate;
import de.ims.icarus2.model.api.manifest.xml.delegates.DriverManifestXmlDelegate.ModuleSpecXmlDelegate;
...
public class DefaultManifestXmlDelegateFactory implements ManifestXmlDelegateFactory {
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.xml.ManifestXmlDelegateFactory#newDelegate(de.ims.icarus2.model.api.manifest.ManifestType)
	 */
	@Override
