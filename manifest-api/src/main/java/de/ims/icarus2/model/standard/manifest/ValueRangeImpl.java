 ...
 * $URL: https://subversion.assembla.com/svn/icarusplatform/trunk/Icarus2Core/core/de.ims.icarus2.model/source/de/ims/icarus2/model/standard/manifest/ValueRangeImpl.java $
 *
...
public class ValueRangeImpl extends AbstractLockable implements ValueRange {
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.ValueRange#getLowerBound()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.ValueRange#getUpperBound()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.ValueRange#getStepSize()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.ValueRange#isLowerBoundInclusive()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.ValueRange#isUpperBoundInclusive()
	 */
	@Override
