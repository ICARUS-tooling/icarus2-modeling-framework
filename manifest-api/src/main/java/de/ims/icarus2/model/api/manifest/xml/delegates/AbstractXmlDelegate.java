...
public abstract class AbstractXmlDelegate<M extends Object> implements ManifestXmlDelegate<M> {
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.xml.ManifestXmlDelegate#setInstance(java.lang.Object)
	 */
	@Override
	 ...
	 *
	 * @see de.ims.icarus2.model.api.manifest.xml.ManifestXmlDelegate#reset()
	 */
	@Override
	public void reset() {
		instance = null;
