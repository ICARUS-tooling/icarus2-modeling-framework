 ...
 * $URL: https://subversion.assembla.com/svn/icarusplatform/trunk/Icarus2Core/core/de.ims.icarus2.model/source/de/ims/icarus2/model/standard/manifest/AbstractManifest.java $
 *
 ...
 * @version $Id: AbstractManifest.java 457 2016-04-20 13:08:11Z mcgaerty $
 *
 */
...
//					&& manifestLocation.equals(other.getManifestLocation())
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.Manifest#getManifestLocation()
	 */
	@Override
...
//		}
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.Manifest#setTemplateId(java.lang.String)
	 */
	@Override
...
//		checkNotNull(templateId);
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.Manifest#isTemplate()
	 */
	@Override
	...
	protected class TemplateLink<D extends Manifest> extends Link<D> {
		...
		/**
		 * @see de.ims.icarus2.model.standard.manifest.AbstractManifest.Link#resolve()
		 */
