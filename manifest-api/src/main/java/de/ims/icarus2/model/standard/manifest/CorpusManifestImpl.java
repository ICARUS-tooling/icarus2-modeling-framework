...
public class CorpusManifestImpl extends AbstractMemberManifest<CorpusManifest> implements CorpusManifest {
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.CorpusManifest#getRootContextManifest()
	 */
	@Override
	...
	/**
	 *
	 * @see de.ims.icarus2.model.api.manifest.CorpusManifest#addCustomContextManifest(de.ims.icarus2.model.api.manifest.ContextManifest)
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.CorpusManifest#removeCustomContextManifest(de.ims.icarus2.model.api.manifest.ContextManifest)
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.CorpusManifest#getContextManifest(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.CorpusManifest#isEditable()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.CorpusManifest#setEditable(boolean)
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.CorpusManifest#addNote(de.ims.icarus2.model.api.manifest.CorpusManifest.Note)
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.CorpusManifest#removeNote(de.ims.icarus2.model.api.manifest.CorpusManifest.Note)
	 */
	@Override
	...
	public static class NoteImpl implements Note {
		...
		/**
		 * @see de.ims.icarus2.model.api.manifest.CorpusManifest.Note#getModificationDate()
		 */
		@Override
		...
		/**
		 * @see de.ims.icarus2.model.api.manifest.CorpusManifest.Note#getName()
		 */
		@Override
		...
		/**
		 * @see de.ims.icarus2.model.api.manifest.CorpusManifest.Note#getContent()
		 */
		@Override
