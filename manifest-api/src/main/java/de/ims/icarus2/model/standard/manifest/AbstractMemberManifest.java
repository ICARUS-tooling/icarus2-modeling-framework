...
public abstract class AbstractMemberManifest<M extends MemberManifest> extends AbstractManifest<M> implements MemberManifest {
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.ModifiableManifest#getOptionsManifest()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.MemberManifest#getProperty(java.lang.String)
	 */
	@Override
	...
	public static class PropertyImpl extends AbstractLockable implements Property {
		...
		/**
		 * @see de.ims.icarus2.model.api.manifest.MemberManifest.Property#getValueType()
		 */
		@Override
		...
		/**
		 * @see de.ims.icarus2.model.api.manifest.MemberManifest.Property#getValue()
		 */
		@Override
		...
		/**
		 * @see de.ims.icarus2.model.api.manifest.MemberManifest.Property#getName()
		 */
		@Override
		public String getName() {
			return name;
		...
		/**
		 * @see de.ims.icarus2.model.api.manifest.MemberManifest.Property#setValue(java.lang.Object)
		 */
		@Override
		...
		/**
		 * @see de.ims.icarus2.model.api.manifest.MemberManifest.Property#getOption()
		 */
		@Override
