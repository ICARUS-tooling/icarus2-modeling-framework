...
import de.ims.icarus2.model.api.manifest.Documentation.Resource;
...
import de.ims.icarus2.model.standard.manifest.DocumentationImpl.ResourceImpl;
...
public class DocumentationXmlDelegate extends AbstractXmlDelegate<Documentation> {
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.xml.ManifestXmlDelegate#writeXml(de.ims.icarus2.model.xml.XmlSerializer)
	 */
	@Override
