...
public abstract class AbstractLayerManifest<L extends LayerManifest> extends AbstractMemberManifest<L> implements LayerManifest {
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.LayerManifest#getContextManifest()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.LayerManifest#getGroupManifest()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.LayerManifest#isLocalLayerType()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.LayerManifest#getLayerType()
	 */
	@Override
	...
	public class TargetLayerManifestImpl implements TargetLayerManifest {
		...
		/**
		 * @see de.ims.icarus2.model.api.manifest.LayerManifest.TargetLayerManifest#getLayerId()
		 */
		@Override
		...
		/**
		 * @see de.ims.icarus2.model.api.manifest.LayerManifest.TargetLayerManifest#getLayerManifest()
		 */
		@Override
		...
		/**
		 * @see de.ims.icarus2.model.api.manifest.LayerManifest.TargetLayerManifest#getPrerequisite()
		 */
		@Override
		...
		/**
		 * @see de.ims.icarus2.model.api.manifest.LayerManifest.TargetLayerManifest#getResolvedLayerManifest()
		 */
		@Override
