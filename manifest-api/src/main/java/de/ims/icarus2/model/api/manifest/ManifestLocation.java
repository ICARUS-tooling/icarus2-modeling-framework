 ...
 * $URL: https://subversion.assembla.com/svn/icarusplatform/trunk/Icarus2Core/core/de.ims.icarus2.model/source/de/ims/icarus2/model/api/manifest/ManifestLocation.java $
 *
 ...
 * @version $Id: ManifestLocation.java 381 2015-04-08 22:25:23Z mcgaerty $
 *
 */
public abstract class ManifestLocation {
	...
	public static class URLManifestLocation extends ManifestLocation {
		...
		/**
		 * @see de.ims.icarus2.model.api.manifest.ManifestLocation#getUrl()
		 */
		@Override
		public URL getUrl() {
			return url;
		...
		/**
		 * @throws IOException
		 * @see de.ims.icarus2.model.api.manifest.ManifestLocation#getInput()
		 */
		@Override
		...
		/**
		 * @throws IOException
		 * @see de.ims.icarus2.model.api.manifest.ManifestLocation#getOutput()
		 */
		@Override
