...
import de.ims.icarus2.model.api.manifest.ManifestFragment;
...
public class DefaultManifestFactory implements ManifestFactory {
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.ManifestFactory#create(de.ims.icarus2.model.api.manifest.ManifestType, java.lang.Object, de.ims.icarus2.util.Options)
	 */
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.ManifestFactory#getManifestLocation()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.ManifestFactory#getRegistry()
	 */
	@Override
