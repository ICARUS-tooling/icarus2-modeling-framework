...
import de.ims.icarus2.model.api.manifest.DriverManifest.Multiplicity;
...
import de.ims.icarus2.model.standard.manifest.DriverManifestImpl.ModuleSpecImpl;
...
public class DriverManifestXmlDelegate extends AbstractMemberManifestXmlDelegate<DriverManifest> {
	...
	public static class ModuleSpecXmlDelegate extends AbstractXmlDelegate<ModuleSpec> {
		...
		/**
		 * @see de.ims.icarus2.model.api.manifest.xml.ManifestXmlElement#writeXml(de.ims.icarus2.model.xml.XmlSerializer)
		 */
		@Override
