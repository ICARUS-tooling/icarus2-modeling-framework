...
public class AnnotationManifestImpl extends AbstractMemberManifest<AnnotationManifest> implements AnnotationManifest {
	...
	/**
	 * @see de.ims.icarus2.model.standard.manifest.AbstractManifest#toString()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.AnnotationManifest#isLocalKey()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.AnnotationManifest#forEachLocalAlias(java.util.function.Consumer)
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.AnnotationManifest#isLocalAlias(java.lang.String)
	 */
	@Override
	 ...
	 *
	 * @see de.ims.icarus2.model.api.manifest.AnnotationManifest#isValuesLimited()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.AnnotationManifest#getValueRange()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.AnnotationManifest#isLocalValueRange()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.AnnotationManifest#getValueSet()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.AnnotationManifest#isLocalValueSet()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.AnnotationManifest#getValueType()
	 */
	@Override
...
//					"No value type available for annotation manifest: "+getId()); //$NON-NLS-1$
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.AnnotationManifest#isLocalValueType()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.AnnotationManifest#isLocalContentType()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus2.model.api.manifest.AnnotationManifest#isLocalNoEntryValue()
	 */
	@Override
