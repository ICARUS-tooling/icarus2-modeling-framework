...
Position markers can be freely mixed in disjunctive or conjunctive expressions.
The \ac{icqp} first converts them into DNF\footnote{\textbf{D}isjunctive \textbf{N}ormal \textbf{F}orm} and then generates a separate branch in the state machine for every term in the DNF.
\begin{Verbatim}[samepage=true]
// legal use cases
[isLast,]
[isBefore(10), pos!="NN"]
