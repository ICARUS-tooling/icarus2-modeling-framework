...
\begin{description}
	...
	\item[\iqlType{name}] The unique identifier of the \repoLink{layer/ItemLayer.java}{item layer} or \repoLink{layer/StructureLayer.java}{structure layer} that serves as target for this lane.
