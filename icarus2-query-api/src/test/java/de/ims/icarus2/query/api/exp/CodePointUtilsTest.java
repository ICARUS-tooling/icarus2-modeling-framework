...
class CodePointUtilsTest {
	...
	static final String test_chinese = "这是一个测试";
...
//	private static final String test_chinese_lc = test_chinese.toLowerCase(Locale.SIMPLIFIED_CHINESE);
	...
	static final String test_georgian = "ეს ტესტია";
	static final String test_georgian_uc = test_georgian.toUpperCase(Locale.ENGLISH);
	static final String test_georgian_lc = test_georgian.toLowerCase(Locale.ENGLISH);

	/** 'This is a test' in Urdu */
	static final String test_urdu = "یہ ایک امتحان ہے";
	static final String test_urdu_uc = test_urdu.toUpperCase(Locale.ENGLISH);
	static final String test_urdu_lc = test_urdu.toLowerCase(Locale.ENGLISH);

	/** 'This is a test' in Hebrew */
	static final String test_hebrew = "یזה מבחן";
	static final String test_hebrew_uc = test_hebrew.toUpperCase(Locale.ENGLISH);
	static final String test_hebrew_lc = test_hebrew.toLowerCase(Locale.ENGLISH);

	// dummy strings using Old Turkic block starting from U+10C00
	static final String test_mixed  = "𐰀𐰁𐰂𐰃𐰄𐰅𐰆𐰇𐰈𐰉";
	static final String test_mixed_uc = test_mixed.toUpperCase(Locale.ENGLISH);
	static final String test_mixed_lc = test_mixed.toLowerCase(Locale.ENGLISH);

	static final String test_mixed2  = "𐰀𐰁𐰂𐰃𐰄𐰅𐰆𐰇𐰈𐰊";
	static final String test_mixed2_uc = test_mixed2.toUpperCase(Locale.ENGLISH);
	static final String test_mixed2_lc = test_mixed2.toLowerCase(Locale.ENGLISH);

	static final String test_mixed3  = "𐰀𐰁𐰂𐰃𐰄𐰎𐰆𐰇𐰈𐰉";
	static final String test_mixed3_uc = test_mixed3.toUpperCase(Locale.ENGLISH);
	static final String test_mixed3_lc = test_mixed3.toLowerCase(Locale.ENGLISH);
	...
	abstract class EqualityTests {
		...
		/**
		 * Test method for {@link de.ims.icarus2.query.api.exp.CodePointUtils#equalsChars(java.lang.CharSequence, java.lang.CharSequence, de.ims.icarus2.util.function.CharBiPredicate)}.
		 */
		@ParameterizedTest
		@MethodSource("de.ims.icarus2.query.api.exp.CodePointUtilsTest#testValues")
		 ...
		 */
		@ParameterizedTest
		@MethodSource("de.ims.icarus2.query.api.exp.CodePointUtilsTest#mismatchedPairsForEquals")
		void testEqualsChars_false(String s1, String s2) {
			assertThat(CodePointUtils.equalsChars(s1, s2, mode.getCharComparator())).isFalse();
		}

//		/**
//		 * Test method for {@link de.ims.icarus2.query.api.exp.CodePointUtils#equalsCodePoints(de.ims.icarus2.util.strings.CodePointSequence, de.ims.icarus2.util.strings.CodePointSequence, de.ims.icarus2.util.function.IntBiPredicate)}.
//		 */
//		@ParameterizedTest
//		@MethodSource("de.ims.icarus2.query.api.exp.CodePointUtilsTest#testValues")
...
//		}
	...
	abstract class ContainsTests {
		...
		/**
		 * Test method for {@link de.ims.icarus2.query.api.exp.CodePointUtils#containsChars(java.lang.CharSequence, java.lang.CharSequence, de.ims.icarus2.util.function.CharBiPredicate)}.
		 */
		@ParameterizedTest
		@MethodSource("de.ims.icarus2.query.api.exp.CodePointUtilsTest#matchedPairsForContains")
		 ...
		 */
		@ParameterizedTest
		@MethodSource("de.ims.icarus2.query.api.exp.CodePointUtilsTest#mismatchedPairsForContains")
		...
		/**
		 * Test method for {@link de.ims.icarus2.query.api.exp.CodePointUtils#containsCodePoints(de.ims.icarus2.util.strings.CodePointSequence, de.ims.icarus2.util.strings.CodePointSequence, de.ims.icarus2.util.function.IntBiPredicate)}.
		 */
		@ParameterizedTest
		@MethodSource("de.ims.icarus2.query.api.exp.CodePointUtilsTest#matchedPairsForContains")
