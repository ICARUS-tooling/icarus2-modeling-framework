...
public enum IqlType {
	...
	ELEMENT_SET("ElementSet", "set", IqlElement.IqlElementSet.class),
	ELEMENT_GROUPING("ElementGrouping", "grouping", IqlElement.IqlElementGrouping.class),
	STRUCTURE("Structure", "structure", IqlElement.IqlStructure.class),
